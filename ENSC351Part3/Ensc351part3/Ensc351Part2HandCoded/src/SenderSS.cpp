// Solution to ENSC 351 Project Part 2.  2019  Prepared by:
//      Copyright (C) 2019 Craig Scratchley, Simon Fraser University
...
void SenderSS::postEvent(unsigned int event, int /*wParam*/ c, int lParam) throw (std::string)
{
	...
	// process transitions from state Sender_TopLevel
